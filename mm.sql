...
DROP TABLE IF EXISTS `mm_user_online`;
CREATE TABLE IF NOT EXISTS `mm_user_online` (
...
INSERT INTO `mm_user_thumbnail` 
(`user_key`, `thumbnail`, `added_at`) 
VALUES 
(UNHEX('00000000000000000000000000000001'), 'test', UTC_TIMESTAMP());
